            ...
            <div className="bg-[#6B3E26] sm:p-2 md:p-2 lg:p-4">
                <div className="grid grid-cols-3 gap-12 px-[30px] sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 p-4">
                    <div>
                        ...
                        <p className="text-[16px] text-gray-300 w-[90%]">Connecting diaspora clients with verified African tailors for perfect custom wear.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="">
                            <div className="flex mt-[10px]">
                                <a className="w-[10%] mr-[10px] object-contain" href="http://" target="_blank"><img className="" src="/icons/Link.webp" alt="" /></a>
                                <a className="w-[10%] mr-[10px] object-contain" href="http://" target="_blank"><img className="" src="/icons/Link2.webp" alt="" /></a>
                                <a className="w-[10%] object-contain" href="http://" target="_blank"><img className="" src="/icons/Link3.webp" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>

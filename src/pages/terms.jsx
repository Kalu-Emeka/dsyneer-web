            ...
            <section className='bg-[#FFFDF9]'>
                <div className="header pt-[140px] pr-[100px] pb-[30px] pl-[130px] text-black bg-[#FFFFFF] sm:pr-[30px] sm:pl-[30px] lg:pr-[100px] lg:pl-[130px]" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                    <div className='flex justify-start flex-col'>
                        <h2 className="mb-2 w-[48%] text-[50px] text-[#1C1C1C] font-normal sm:w-full md:w-full sm:text-[25px] md:text-[27px] lg:text-[40px]">Terms of Service</h2>
                ...
                <div className='border ml-[130px] px-[30px] py-[30px] rounded-[10px] mb-[50px] w-[65%]'>
                    <p className='text-[16px]'>Welcome to DSYNEER. These Terms of Service ("Terms") govern your access to and use of our platform. By using DSYNEER, you agree to comply with and be bound by these Terms. Please read them carefully.</p>
                    <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>1. Acceptance of Terms</h2>
                        <p className='text-[15px]'>If you do not agree to these terms, please do not use our services.</p>
                        <p className='text-[15px] my-[10px]'>We reserve the right to modify these terms at any time, and your continued use constitutes acceptance of any changes.</p>
                    </div>
                    <div>
                     ...
                     <div>
                        ...
                        <p className='text-[15px]'>You must create an account to use our services.</p>
                        <p className='text-[15px] my-[10px]'>You are responsible for maintaining the security of your account credentials.</p>
                        <p className='text-[15px] my-[10px]'>You must provide accurate and complete information when creating your account.</p>
                        <p className='text-[15px] my-[10px]'>You must be at least 18 years old to create an account.</p>
                        <p className='text-[15px] my-[10px]'>One person or business may not maintain multiple accounts.</p>
                    </div>
                     <div>
                     ...
                     <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>7. Order Cancellations and Refunds</h2>
                     ...
                     <div>
                        ...
                        <p className='text-[15px] my-[10px]'>Final decisions on disputes are at DSYNEER's discretion.</p>
                    </div>
                     <div>
                     ...
                     <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>10. Prohibited Activities</h2>
                        <p className='text-[15px]'>Circumventing the platform to conduct transactions externally.</p>
                        <p className='text-[15px] my-[10px]'>Harassment, abuse, or discrimination against other users.</p>
                        <p className='text-[15px] my-[10px]'>Posting false, misleading, or fraudulent information.</p>
                        <p className='text-[15px] my-[10px]'>Attempting to hack, disrupt, or damage the platform.</p>
                        <p className='text-[15px] my-[10px]'>Violating any applicable laws or regulations.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>12. Privacy and Data Protection</h2>
                        <p className='text-[15px]'>Your use of DSYNEER is also governed by our Privacy Policy.</p>
                        <p className='text-[15px] my-[10px]'>We collect and process data as described in our Privacy Policy.</p>
                        <p className='text-[15px] my-[10px]'>You consent to our data practices by using our services.</p>
                    </div>
                    <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>13. Termination</h2>
                        <p className='text-[15px]'>We reserve the right to suspend or terminate accounts for violations of these terms.</p>
                        <p className='text-[15px] my-[10px]'>You may close your account at any time through account settings.</p>
                        <p className='text-[15px] my-[10px]'>Upon termination, your right to use the platform immediately ceases.</p>
                        <p className='text-[15px] my-[10px]'>Certain provisions of these terms survive termination.</p>
                    </div>
                    <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>14. Governing Law</h2>
                        <p className='text-[15px]'>These terms are governed by the laws of Nigeria.</p>
                        <p className='text-[15px] my-[10px]'>Any disputes shall be resolved in the courts of Lagos, Nigeria.</p>
                        <p className='text-[15px] my-[10px]'>You consent to the exclusive jurisdiction of these courts.</p>
                    </div>
                    <div>
                        <h2 className='text-[25px] font-medium my-[20px]'>15. Contact Information</h2>
                        <p className='text-[15px]'>For questions about these Terms of Service, contact us at:</p>
                        <p className='text-[15px] my-[10px]'>Email: legal@dsyneer.com</p>
                        <p className='text-[15px] my-[10px]'>Address: Lagos, Nigeria</p>
                    </div>
                    <div className='bg-[#F0ECE9] px-[20px] py-[20px] rounded-lg border-2 border border-[#F0ECE9] mt-[20px]'>
                        <h2 className='text-[18px] font-medium mb-[20px]'>Agreement</h2> 
                        <p>By using DSYNEER, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy. If you have any questions, please contact our support team.</p>
                    </div>
                </div>
            </section>
            <Footer/>
